    ...
    try {
        await new Promise((resolve, reject) => {
            busboy.on('file', (fieldname, file, filename, encoding, mimetype) => {
                ...
                if (!finalName) {
                    finalName = `PFKPossumBingo_${Date.now()}`;
                }

                uploadedFilename = finalName;
                blobName = `PFKPossumBingo_${finalName}`;
        ...
        const webhookUrl = 'https://fme.ethosgis.com/fmerest/v3/automations/workflows/9c72c881-da26-4d4d-8229-195fd669661b/ef4e8821-851c-2fad-902e-d7fb19cbb2e1/message';
        ...
        context.res = {
            status: 500,
            body: "Process failed. Something went wrong on the server. Please contact Ethos Environmental"
        };
    }
};
